    ...
    methods: {
                ...
                if (valid) {
                    if(that.id){
                        ...
                        axios({
                            // 默认请求方式为get
                            method: 'post',
                            url: '/admin/materialCategory/update',
                            // 传递参数
                            data: that.formData,
                            responseType: 'json',
                            headers:{
                        ...
                        axios({
                            // 默认请求方式为get
                            method: 'post',
                            url: '/admin/materialCategory/add',
                            // 传递参数
                            data: that.formData,
                            responseType: 'json',
                            headers:{
        ...
        getDetail(id){
            ...
            axios({
                // 默认请求方式为get
                method: 'post',
                url: '/admin/materialCategory/getInfo',
                // 传递参数
                data: {
                    id:id
                },
                ...
                this.formData = {
                    name: res.data.maca_name,
                    sort: res.data.maca_sort,
                    remark: res.data.maca_remark,
                    status: res.data.maca_status,
                }
            }).catch(error => {
                this.$message.error('请求失败');
            });
