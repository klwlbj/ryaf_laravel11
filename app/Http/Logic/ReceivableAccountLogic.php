...
//                    $nodeId = self::$nodeRelationArr[$area];
                ...
                $insert = [
                    ...
                    'reac_device_funds' => 100*($installationCount-$givenCount),
...
//            print_r($addressList);die;
            ...
            $insertData = [
                ...
                'reac_device_funds' => ($value['order_device_funds'] > 0) ? $value['order_device_funds'] : ($deviceCountArr[$value['order_id']] ?? 0) * 100,
