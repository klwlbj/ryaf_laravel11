...
//            ->whereRaw("(smde_yunchuang_id = 0 or smde_yunchuang_id is null)")
...
//            ])->get()->toArray();
        ...
        $placeList = Place::query()
            ...
            ->whereRaw("(plac_yunchuang_id = 0 or plac_yunchuang_id is null)")
            ->where('order_status','=','交付完成')
            ->where('plac_node_ids','like','%,5,%')
